...
class Template
{
    ...
    public static function load($id)
    {
        ...
        $template_info = Database::getInstance()->query(
            "SELECT * FROM {chatmailtemplate} WHERE templateid = :id",
            array(':id' => $id),
    ...
    public static function loadByName($name, $locale, $strict = false)
    {
        ...
        $template_info = Database::getInstance()->query(
            "SELECT * FROM {chatmailtemplate} WHERE name = :name AND locale = :locale",
            array(
                ':name' => $name,
                ':locale' => $locale,
            ),
    ...
    public function save()
    {
        ...
        if (!$this->id) {
            ...
            $db->query(
                ('INSERT INTO {chatmailtemplate} (locale, name, subject, body) '
            ...
            $db->query(
                ('UPDATE {chatmailtemplate} SET locale = :locale, name = :name, '
