...
function track_get_path($visitor)
{
    ...
    $query_result = $db->query(
        "SELECT address, visittime FROM {chatvisitedpage} WHERE visitorid = ?",
...
function track_remove_old_visitors()
{
    ...
    if ($lock->get()) {
        ...
        // "delete" event later.
        $rows = $db->query(
            ("SELECT visitorid FROM {chatsitevisitor} "
